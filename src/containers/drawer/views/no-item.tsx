...
export default function NoItem({location}) {
  ...
  return (
    <>
      <div className="w-full flex justify-center flex-shrink-0 relative px-30px py-20px mb-30px border-b border-gray-200">
        ...
        <h2 className="font-semibold text-21px m-0 text-center">{location ? "Pas d'élements dans votre panier de location" : "Pas d'éléments dans votre panier d'achat"}</h2>
      </div>

      <div className="flex-auto">
        <p className="text-center text-gray-900 px-10 leading-loose">
          Vous n'avez pas encore ajouté des éléments
        </p>
